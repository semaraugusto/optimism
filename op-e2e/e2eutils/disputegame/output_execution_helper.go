...
func (g *OutputExecutionGameHelper) NewStartChallenger(
	ctx context.Context,
	l2Node string,
	name string,
...
func (g *OutputExecutionGameHelper) CreateHonestActor(ctx context.Context, l2Node string) *OutputHonestHelper {
...
func (g *OutputExecutionGameHelper) CreateDishonestHelper(ctx context.Context, l2Node string, defender bool) *DishonestHelper {
