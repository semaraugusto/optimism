...
contract Deploy is Deployer {
    ...
    returns (Types.ContractSet memory proxies_)
  {
    proxies_ = Types.ContractSet({
      ...
      OptimismMintableERC20Factory: getAddress(
        'OptimismMintableERC20FactoryProxy'
      ),
  ...
  function _new_run() internal virtual {
  ...
  function newSetupOpChain() public {
  ...
  function newInitializeImplementations() public {
  ...
  ///         Note this function does not have the broadcast modifier.
  function removeDeployerFromSafe(
    string memory _name,
    ...
    _callViaSafe({
      ...
      _data: abi.encodeCall(
        ...
        (sentinelOwners, msg.sender, _newThreshold)
      )
    });
  ...
  function deployL1StandardBridgeProxy()
    public
    broadcast
  ...
  function deployL1CrossDomainMessengerProxy()
    public
    broadcast
    returns (address addr_)
  {
  ...
  function deployDataAvailabilityChallengeProxy()
    public
    broadcast
    returns (address addr_)
  {
    ...
    console.log(
      'DataAvailabilityChallengeProxy deployed at %s',
      address(proxy)
    );
    ...
    returns (address addr_)
  {
    ...
    console.log(
      'OptimismMintableERC20Factory deployed at %s',
      address(factory)
    );
  ...
  function deployDelayedWETH() public broadcast returns (address addr_) {
    ...
    DelayedWETH weth = new DelayedWETH{salt: _implSalt()}(
      cfg.faultGameWithdrawalDelay()
    );
  ...
  function deployMips() public broadcast returns (address addr_) {
    ...
    MIPS mips = new MIPS{salt: _implSalt()}(
    ...
    returns (address addr_)
  {
    ...
    AnchorStateRegistry anchorStateRegistry = new AnchorStateRegistry{
      salt: _implSalt()
    }(DisputeGameFactory(mustGetAddress('DisputeGameFactoryProxy')));
    save('AnchorStateRegistry', address(anchorStateRegistry));
    console.log(
      'AnchorStateRegistry deployed at %s',
  ...
  function deployL1StandardBridge() public broadcast returns (address addr_) {
    ...
    ChainAssertions.checkL1StandardBridge({
      _contracts: contracts,
      _isProxy: false
    });
  ...
  function initializeSuperchainConfig() public broadcast {
    address payable superchainConfigProxy = mustGetAddress(
    ...
    _upgradeAndCallViaSafe({
      ...
      _innerCallData: abi.encodeCall(
        ...
        (cfg.superchainConfigGuardian(), false)
      )
    });
  ...
  function initializeDisputeGameFactory() public broadcast {
    ...
    string memory version = DisputeGameFactory(disputeGameFactoryProxy)
      .version();
  ...
  function initializeDelayedWETH() public broadcast {
    ...
    _upgradeAndCallViaSafe({
      ...
      _innerCallData: abi.encodeCall(
        ...
        (msg.sender, SuperchainConfig(superchainConfigProxy))
      )
    });
  ...
  function initializeAnchorStateRegistry() public broadcast {
    ...
    address anchorStateRegistryProxy = mustGetAddress(
    ...
    string memory version = AnchorStateRegistry(
  ...
  function initializeL1StandardBridge() public broadcast {
    ...
    string memory version = L1StandardBridge(payable(l1StandardBridgeProxy))
      .version();
  ...
  function initializeOptimismMintableERC20Factory() public broadcast {
    ...
    address optimismMintableERC20Factory = mustGetAddress(
  ...
  {
    if (
      block.chainid == Chains.LocalDevnet || block.chainid == Chains.GethDevnet
    ) {
      ...
      mipsAbsolutePrestate_ = Claim.wrap(
        abi.decode(Process.run(commands), (bytes32))
      );
      console.log(
      ...
      console.log(
        '[Cannon Dispute Game] Using absolute prestate from config: %x',
  ...
  function setPermissionedCannonFaultGameImplementation(
    bool _allowUpgrade
  ) public broadcast {
  ...
  function _setFaultGameImplementation(
    ...
    if (
      address(_factory.gameImpls(_params.gameType)) != address(0) &&
      !_allowUpgrade
    ) {
      console.log(
    ...
    if (rawGameType != GameTypes.PERMISSIONED_CANNON.raw()) {
      ...
      _factory.setImplementation(
        ...
        new PermissionedDisputeGame({
          ...
          _splitDepth: cfg.faultGameSplitDepth(),
          _clockExtension: Duration.wrap(uint64(cfg.faultGameClockExtension())),
          _maxClockDuration: Duration.wrap(
            uint64(cfg.faultGameMaxClockDuration())
          ),
          _vm: _params.faultVm,
          _weth: _params.weth,
          _anchorStateRegistry: _params.anchorStateRegistry,
  ...
  function initializeDataAvailabilityChallenge() public broadcast {
    ...
    address dataAvailabilityChallengeProxy = mustGetAddress(
      'DataAvailabilityChallengeProxy'
    );
    address dataAvailabilityChallenge = mustGetAddress(
    ...
    DataAvailabilityChallenge dac = DataAvailabilityChallenge(
      payable(dataAvailabilityChallengeProxy)
    );
